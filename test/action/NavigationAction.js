jQuery.sap.declare("de.abat.scrumui5.test.action.NavigationAction");
jQuery.sap.require("sap.ui.test.Opa5");

de.abat.scrumui5.test.action.NavigationAction = sap.ui.test.Opa5.extend("de.abat.scrumui5.test.action.NavigationAction", {
