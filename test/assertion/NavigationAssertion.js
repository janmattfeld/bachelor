jQuery.sap.declare("de.abat.scrumui5.test.assertion.NavigationAssertion");
jQuery.sap.require("sap.ui.test.Opa5");

de.abat.scrumui5.test.assertion.NavigationAssertion = sap.ui.test.Opa5.extend("de.abat.scrumui5.test.assertion.NavigationAssertion", {
